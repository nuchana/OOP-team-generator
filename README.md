...
* Run tests to evaluate what works and what doesn't work
...
* My app will run as a Node CLI to gather information about each employee. Please find my example of what my app would look like.
